...
const tableColumns = [
  ...
  { title: 'Last Approved By', field: 'lastappr' },
  { title: 'Last Updated', field: 'time'},  // add type: 'numeric' if required
  ]
...
const tableData = [
  ...
  { id: '4', wname: "Financial Approval",status: 'Rejected',lastappr: 'Dr. Ratnesh Kumar',time: 5},
  { id: '6', wname: "Best Detective", status: 'Approved', lastappr: 'Captain Holt', time: 25},
  { id: '1', wname: "Best Sidekick", status: 'Intermediate', lastappr: 'Jake Peralta', time: 10},
  { id: '2', wname: "Job Application",status: 'Rejected', lastappr: 'Director VNIT', time: 30},
  { id: '7', wname: "Need Plancks Constant", status:'Intermediate', lastappr:'Eleven', time: 44},
  { id: '5', wname: "Approval for teesri manzil", status:'Rejected', lastappr:'Neta', time: 3},
]
